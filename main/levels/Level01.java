...
public class Level01 extends BasicGameState {
	...
	public void init(GameContainer gc, StateBasedGame sbg)
		...
		if( !HUNT.backup ) {
			map = new Map( new TiledMap( "res/levels/level01/map-1.tmx" ) , "solid", "green" );
		...
		// SCREENS
		levelLoadScreen = new Image( "res/levels/screens/level 1 screen.png" );
