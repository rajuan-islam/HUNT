...
public class Level02 extends BasicGameState {
	...
	public void init(GameContainer gc, StateBasedGame sbg)
		...
		if( !HUNT.backup ) {
			map = new Map( new TiledMap( "res/levels/level02/map 2.tmx" ) , "solid", "green" );
		...
		// SCREENS
		levelLoadScreen = new Image( "res/levels/screens/level 2 screen.png" );
